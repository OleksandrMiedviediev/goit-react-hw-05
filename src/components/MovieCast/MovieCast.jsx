    ...
    <div>
      ...
      <ul className={css.list}>
        ...
        <li className={css.li} key={actor.id}>
          {actor.profile_path && <img className={css.image} src={actor.profile_path ? `https://image.tmdb.org/t/p/w500/${actor.profile_path}` : defaultImg} alt={actor.name} width={150} />}
